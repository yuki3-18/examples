...
parser.add_argument('--input', type=str, default="E:/git/pytorch/vae/results/artificial/z_24/B_0.1/R_0/gen/rec/list.txt",
                    help='File path of input images')
parser.add_argument('--patch_side', type=int, default=9,
                    help='how long patch side for input')
parser.add_argument('--num_of_data', type=int, default=18,
