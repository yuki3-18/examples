...
parser.add_argument('--input', type=str, default="E:/git/pytorch/vae/results/artificial/hole/z_6/B_0.1/L_0/spe/list.txt",
                    help='File path of input images')
parser.add_argument('--patch_side', type=int, default=9,
                    help='how long patch side for input')
parser.add_argument('--num_of_data', type=int, default=903,
                    help='number of dataset')
parser.add_argument('--output', type=str, default="E:/git/pytorch/vae/results/artificial/hole/z_6/B_0.1/L_0/spe/",
